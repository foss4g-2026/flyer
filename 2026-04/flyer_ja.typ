...
#let image_path = "../assets/icch.jpg"
  ...
  block(width: 100%)[
    #align(center)[
      #box[
        // 影（黒いテキスト）
        #place(dx: 2pt, dy: 2pt)[
          #text(fill: rgb(0, 0, 0, 60%), size: 40pt, weight: "bold",
...
#place(
  ...
  dy: img_height - 16pt,
  dx: -6pt,
  text(size: 6pt, fill: white.transparentize(20%), font: "Helvetica Neue")[©HCVB]
)
  ...
  #grid(
    ...
    block(height: column_height)[
      ...
      #grid(
        ...
        [#content.communitysprint.at(0).date_start \ #text(size: 8.5pt)[#content.communitysprint.at(0).venue]]
      )
    ],
